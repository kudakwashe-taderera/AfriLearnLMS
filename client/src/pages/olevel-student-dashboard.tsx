...
export default function OLevelStudentDashboard() {
  const { user } = useAuth();
  ...
  const progressSteps = [
    { id: 'subject-selection', label: 'Subject Selection', complete: !!studentSubjects, href: '/olevel-subject-selection' },
    { id: 'career-exploration', label: 'Career Exploration', complete: false, href: '/career-guidance' },
    { id: 'course-materials', label: 'Course Materials', complete: false, href: '/courses?level=o_level' },
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-neutral-50">
          ...
          <div className="mb-6">
            ...
            <p className="text-umber-600">
              Focus on building your core academic foundation as you progress through your O-Level education.
            </p>
          </div>
                    ...
                    {studentSubjects ? (
                      ...
                      <>
                        ...
                        <p className="text-blue-800 mb-4">
                          Choose subjects that align with your career interests and strengths.
                        </p>
                      </>
                    )}
                  </div>
          ...
          <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-border">
              <CardHeader className="pb-3">
                <CardTitle className="text-xl font-semibold">Career Exploration</CardTitle>
                <CardDescription>Discover potential career paths based on your interests</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <Compass className="h-5 w-5 text-primary-500" />
                    <span className="text-umber-700">Explore careers that match your subjects</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Lightbulb className="h-5 w-5 text-primary-500" />
                    <span className="text-umber-700">Develop study skills for success</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <School className="h-5 w-5 text-primary-500" />
                    <span className="text-umber-700">Prepare for A-Level education</span>
                  </div>
                </div>
              </CardContent>
              <CardFooter>
                <Button variant="outline" asChild className="w-full gap-2" size="sm">
                  <Link href="/career-guidance?focus=exploration">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card className="border-border">
              ...
              <CardContent className="space-y-4">
                <Link href="/courses?level=o_level" className="flex items-center justify-between hover:bg-gray-50 p-2 rounded-md group">
                  <div className="flex items-center gap-3">
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-sm text-umber-700">O-Level Progress</span>
                    <span className="text-sm font-medium text-umber-900">25%</span>
                  </div>
            ...
            <Card className="border-border">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg font-semibold">A-Level Preparation</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm text-umber-600">
                  Start preparing for A-Level studies by exploring potential subjects and requirements.
                </p>
                
                <Link href="/universities" className="flex items-center justify-between hover:bg-gray-50 p-2 rounded-md group">
                  <div className="flex items-center gap-3">
                    <School className="h-5 w-5 text-primary-500" />
                    <span className="text-umber-700 group-hover:text-primary-600">Explore Universities</span>
                  </div>
                  <ChevronRight className="h-4 w-4 text-umber-500" />
                </Link>
              </CardContent>
